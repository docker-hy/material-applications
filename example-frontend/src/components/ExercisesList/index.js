...
const ExerciseList = () => (
  <div className="exercise-list">
    <h3>Part 1</h3>
    <Exercise exerciseNumber="1.10" ExerciseComponent={<AmIRunning />} />
    <Exercise exerciseNumber="1.12" ExerciseComponent={<BackendConnection />} />
    <h3>Part 2</h3>
    <Exercise exerciseNumber="2.5" ExerciseComponent={<RedisSetup />} />
